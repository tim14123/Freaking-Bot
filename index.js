...
bot.on('guildMemberAdd', member => {
    ...
    member.roles.add('829434726720471131')
    let embed = new Discord.MessageEmbed()
        ...
        .setTimestamp()
    member.guild.channels.cache.find(channel => channel.id === '829432652238553108').send(embed)
});
bot.on('guildMemberRemove', member => {
    let embed = new Discord.MessageEmbed()
        ...
        .setFooter('Nous sommes désormais ' + member.guild.memberCount + ' membres sur le serveur !')
        .setTimestamp()
    member.guild.channels.cache.find(channel => channel.id === '829432655056732250').send(embed)
});
...
bot.on('message', async message => {
    ...
    if(mention == undefined){
        ...
        mention.roles.add('829472848346611754');
        setTimeout(function () {
            mention.roles.remove('829434726720471131')
...
bot.on('messageDelete', async message => {
    ...
    .setTimestamp()
    bot.guilds.cache.get('817855554877390898').channels.cache.get('829469387702272011').send(embedLogsMessageDelete)
});
bot.on('roleUpdate', async (OldRole, newRole) => {
    ...
    .setTimestamp()
    bot.guilds.cache.get('817855554877390898').channels.cache.get('829469387702272011').send(embedLogsRoleUpdate)
});
bot.on('roleCreate', async (newRole) => {
    ...
    .setTimestamp()
    bot.guilds.cache.get('817855554877390898').channels.cache.get('829469387702272011').send(embedLogsRoleCreate)
});
bot.on('roleDelete', async (role) => {
    ...
    bot.guilds.cache.get('817855554877390898').channels.cache.get('829469387702272011').send(embedLogsRoleDelete)
});
bot.on('inviteCreate', async invite => {
    ...
    .setTimestamp()
    bot.guilds.cache.get('817855554877390898').channels.cache.get('829469387702272011').send(embedLogsInviteCreate)
});
bot.on('inviteDelete', async invite => {
    ...
    .setTimestamp()
    bot.guilds.cache.get('817855554877390898').channels.cache.get('829469387702272011').send(embedLogsInviteDelete)
});
...
bot.login('ODM0NTM2NDI3NTcxMTE4MTQw.YICUnQ.J9I3-itKpHT_KeZQsverdL7SqFI')